...
Dashboard: `http://<truenas-ip>:8080`, über cloudflared zusätzlich unter `media.truenasserver.com`.
...
`https://jd.truenasserver.com`. Die Sortierung selbst braucht die Verbindung nicht, der
